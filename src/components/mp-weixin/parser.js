  ...
  for (var e = t.indexOf("&"); -1 !== e; ) {
    ...
    "#" === t[e + 1]
      ? ((a = parseInt(("x" === t[e + 2] ? "0" : "") + t.substring(e + 2, s))),
        isNaN(a) ||
          (t = t.substr(0, e) + String.fromCharCode(a) + t.substr(s + 1)))
      : ((a = t.substring(e + 1, s)),
        (n.entities[a] || ("amp" === a && i)) &&
          (t = t.substr(0, e) + (n.entities[a] || "&") + t.substr(s + 1))),
      (e = t.indexOf("&", e + 1));
  }
  return t;
}
...
(s.prototype.parse = function(t) {
  for (var i = this.plugins.length; i--; )
    this.plugins[i].onUpdate && (t = this.plugins[i].onUpdate(t, n) || t);
  ...
  (s.prototype.onOpenTag = function(t) {
    ...
    if (
      (r[i.name] && (e.class = r[i.name] + (e.class ? " " + e.class : "")),
      "embed" === i.name)
    ) {
      var l = e.src || "";
      l.includes(".mp4") ||
    ...
    if (
        ...
        if (
          ...
          for (var p = this.stack.length; p--; ) {
            ...
            "table" !== u.name ||
              ...
              (!c.display || c.display.includes("inline")
                ? (i.t = "inline-block")
                : (i.t = c.display),
              (c.display = void 0));
            var g = u.attrs.style || "";
              ...
              if (g.includes("flex") && "100%" === c.width)
                ...
                g.includes("inline-block") &&
                  (c.width && "%" === c.width[c.width.length - 1]
                    ? ((u.attrs.style += ";max-width:" + c.width),
                      (c.width = ""))
      ...
      for (var w in c)
        c[w] &&
          (e.style += ";"
            .concat(w, ":")
            .concat(c[w].replace(" !important", "")));
      e.style = e.style.substr(1) || void 0;
    } else
      ("pre" === i.name ||
        ((e.style || "").includes("white-space") && e.style.includes("pre"))) &&
        2 !== this.pre &&
        (this.pre = i.pre = 1),
        (i.children = []),
        this.stack.push(i);
  ...
  (s.prototype.popNode = function() {
    ...
    if (
      ...
      if ("a" === t.name || "ad" === t.name) this.expose();
        ...
        (d.height || "").includes("auto") && (d.height = void 0),
          (t.children = void 0);
        ...
        B[i.type] &&
          ((i.style += ";list-style-type:" + B[i.type]), (i.type = void 0)),
          (t.c = 1);
    ...
    var G =
      a &&
      ((a.attrs.style || "").includes("flex") ||
        (a.attrs.style || "").includes("grid")) &&
      !t.c &&
      !(d.display || "").includes("inline");
    G && (t.f = ";max-width:100%"),
      s.length >= 50 && t.c && !(d.display || "").includes("flex") && e(s);
    for (var M in d)
      if (d[M]) {
  ...
  (a.prototype.text = function() {
    ...
    if ((t >= "a" && t <= "z") || (t >= "A" && t <= "Z"))
      ...
      if ("/" === t && ((i >= "a" && i <= "z") || (i >= "A" && i <= "Z")))
        return (
          (this.i += 2), (this.start = this.i), void (this.state = this.endTag)
        );
      var e = "--\x3e";
      ("!" === t &&
